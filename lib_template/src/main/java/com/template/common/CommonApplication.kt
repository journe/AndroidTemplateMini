...
import com.template.base.app.ApplicationLifecycle
import com.template.base.utils.ForegroundBackgroundObserver
import com.template.base.utils.ProcessUtils
import com.template.base.utils.network.NetworkStateClient
...
//        )
	...
	private fun initLogger(): String {
		Logger.addLogAdapter(object :
			AndroidLogAdapter(
				PrettyFormatStrategy.newBuilder().tag("cheese").build()
			) {
